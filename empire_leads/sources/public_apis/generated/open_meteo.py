...
source returns []. To make it real:
  1. Read the docs at: https://open-meteo.com/
...
logger = logging.getLogger("empire-leads.public_apis.open_meteo")
...
def _fetch(limit: int = 20) -> list[dict]:
    ...
    try:
        ...
        try:
            ...
            logger.info("[open_meteo] docs URL returned non-JSON (HTML?) — stub returns []")
            return []
        ...
        logger.warning("[open_meteo] fetch failed: %s", e)
        return []
